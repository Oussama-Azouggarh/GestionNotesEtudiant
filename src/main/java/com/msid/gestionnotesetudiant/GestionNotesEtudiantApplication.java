...
//------------------------------------------------------------------------------------------------------------------------------------------------------
				...
				Matiere matiere11=Matiere.builder().Nom("Mathématiques").devoir1(10).devoir2(14).devoir3(20).Coeff(4).etudiant(E2).build();
				matiere11.calculerMoyenneMatiere();
				matiereRepository.save(matiere11);
				
				noteRepository.save(note2);

				Matiere matiere12=Matiere.builder().Nom("Physique et Chimie").devoir1(15).devoir2(14).devoir3(20).Coeff(4).etudiant(E2).build();
				...
				Matiere matiere13=Matiere.builder().Nom("Français").devoir1(16).devoir2(14).devoir3(20).Coeff(3).etudiant(E2).build();
				...
				Matiere matiere15=Matiere.builder().Nom("Informatique").devoir1(12).devoir2(14).devoir3(20).Coeff(2).etudiant(E2).build();
				...
				Matiere matiere17=Matiere.builder().Nom("Éducation Islamique").devoir1(9.9).devoir2(14).devoir3(20).Coeff(2).etudiant(E2).build();
				...
				Matiere matiere19=Matiere.builder().Nom("Philosophie").devoir1(15).devoir2(14).devoir3(20).Coeff(2).etudiant(E2).build();
				matiere19.calculerMoyenneMatiere();
				matiereRepository.save(matiere19);
				
				noteRepository.save(note9);

				Matiere matiere20=Matiere.builder().Nom("Éducation physique et sportive").devoir1(15.0).devoir2(12).devoir3(17).Coeff(2).etudiant(E2).build();
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------
				...
				Matiere matiere22=Matiere.builder().Nom("Mathématiques").devoir1(10).devoir2(14).devoir3(20).Coeff(4).etudiant(E3).build();
				matiere22.calculerMoyenneMatiere();
				matiereRepository.save(matiere22);
				
				noteRepository.save(note2);

				Matiere matiere00=Matiere.builder().Nom("Physique et Chimie").devoir1(15).devoir2(14).devoir3(20).Coeff(4).etudiant(E3).build();
				matiere00.calculerMoyenneMatiere();
				matiereRepository.save(matiere00);
				
				noteRepository.save(note1);

                Matiere matiere23=Matiere.builder().Nom("Sciences de la Vie et de la Terre").devoir1(15).devoir2(14).devoir3(20).Coeff(4).etudiant(E3).build();
                matiere23.calculerMoyenneMatiere();
                matiereRepository.save(matiere23);
                
                noteRepository.save(note1);

				Matiere matiere24=Matiere.builder().Nom("Français").devoir1(16).devoir2(14).devoir3(20).Coeff(3).etudiant(E3).build();
				matiere24.calculerMoyenneMatiere();
				matiereRepository.save(matiere24);
				
				noteRepository.save(note3);

				Matiere matiere25=Matiere.builder().Nom("Anglais").devoir1(17).devoir2(14).devoir3(11).Coeff(3).etudiant(E3).build();
				matiere25.calculerMoyenneMatiere();
				matiereRepository.save(matiere25);
				
				noteRepository.save(note4);

				Matiere matiere26=Matiere.builder().Nom("Informatique").devoir1(12).devoir2(14).devoir3(20).Coeff(2).etudiant(E3).build();
				...
				Matiere matiere28=Matiere.builder().Nom("Éducation Islamique").devoir1(9.9).devoir2(14).devoir3(20).Coeff(2).etudiant(E3).build();
				matiere28.calculerMoyenneMatiere();
				matiereRepository.save(matiere28);
				
				noteRepository.save(note7);

				Matiere matiere29=Matiere.builder().Nom("Histoire et Géographie").devoir1(19).devoir2(14).devoir3(10).Coeff(2).etudiant(E3).build();
